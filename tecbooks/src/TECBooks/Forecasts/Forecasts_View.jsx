...
function Forecasts_View() {
    const { bizInfo, revenueData } = useExcel()
    ...
    useEffect(() =>  {
        if (revenueData) {
            ...
            setXTitle(getXLabel(past, future, bizInfo.startMonth))
            setXAxis(getXCategories(past, future, bizInfo.startMonth, interval))
    
            const newData = getData(past, future, activeForecasts, revenueData, bizInfo.startMonth, interval, smoothing, dataType, alpha)
            setSeriesData(newData)
        }
    }, [past, future, activeForecasts, bizInfo, revenueData, interval, smoothing, dataType, alpha])
