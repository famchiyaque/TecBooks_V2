  ...
  return (
    <div className="page-container blue-page" id="sims-page">
      ...
      <div className="sims-container">
        <Typography
          variant="h3"
          sx={{ fontWeight: "700", padding: "0 0 0.5rem 0", color: "#073a5a" }}
        >
        ...
        <div className="sims-grid">
          <SimCard
            ...
            desc={
              "Create, save, and compare the financial returns of your potential projects and investment opportunities."
            }
          ...
          <SimCard
            ...
            desc={
              "Make and compare sales forecasts with various different models using your own data or built-in methods."
            }
