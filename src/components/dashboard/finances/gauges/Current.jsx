...
import { useLegacySimData as useSimData } from '@/contexts/LegacySimDataContext'
...
function GaugeChart() {
  ...
  const chartConfigs = {
    ...
    dataSource: {
      ...
      colorRange: {
        color: [
          { minValue: '0', maxValue: '1', code: '#F2726F' },
          { minValue: '1', maxValue: '1.5', code: '#FFC533' },
          { minValue: '1.5', maxValue: '3', code: '#62B58F' },
        ],
      },
      dials: {
        dial: [{ value: currentRatio }],
      },
    },
  }
