...
/**
 * Utilidades section: editable Operating Expenses breakdown (RF-55, same
 * double-click pattern as the Cost Table) followed by the read-only summary
 * (Net Sales through Operating Profit). Same underlying calculation as
 * ProjectCostSummary (shares buildCostOfSales).
 */
