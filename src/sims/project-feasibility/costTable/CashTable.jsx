  ...
  const saldoInicialByYear = React.useMemo(() => {
    ...
    years.forEach((year, index) => {
      ...
      const prevEntradaValue = (rowKey) =>
        rowKey === "saldoInicial"
          ? map[prevYear]
          : baseEntradaValue(rowKey, prevYear, rowByYear);
      ...
      const prevOutflowValue = (rowKey) =>
        outflowBaseValue(rowKey, prevYear, rowByYear, capexByYear);
