...
import Sales from '@/components/dashboard/finances/margins/Sales'
import Operating from '@/components/dashboard/finances/margins/Operating'
import Gross from '@/components/dashboard/finances/margins/Gross'
// import Waterfall from '@/components/dashboard/finances/graphs/Waterfall'
import ROS from '@/components/dashboard/finances/margins/ROS'
import Debt from '@/components/dashboard/finances/gauges/Debt'
import Current from '@/components/dashboard/finances/gauges/Current'
import Quick from '@/components/dashboard/finances/gauges/Quick'
import Capital from '@/components/dashboard/finances/margins/Capital'
import AssetTurnover from '@/components/dashboard/finances/graphs/AssetBullet'
import InventoryTurnover from '@/components/dashboard/finances/graphs/InventoryBullet'
import { Typography } from '@mui/material'
import { useLegacySimData } from '@/contexts/LegacySimDataContext'
