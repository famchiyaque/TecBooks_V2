    ...
    const mockNotifications = [
      {
        ...
        content: 'You have been invited to join the Network Security Simulation Game. The game starts on March 1st and ends on March 15th. Click to view details and join.',
        type: 'game_invitation',
        gameId: 'game001',
        gameName: 'Network Security Simulation'
      },
      {
        id: 'team-assignment-001',
        title: 'Team Assignment',
        date: new Date(Date.now() - 86400000).toISOString(), // Yesterday
        content: 'You have been assigned to Team Alpha for the Network Security Simulation Game. Your teammates will be notified shortly.',
        type: 'team_assignment',
        gameId: 'game001',
        teamName: 'Team Alpha'
      },
      {
        id: 'grade-available-001',
        title: 'Grade Available',
        date: new Date(Date.now() - 172800000).toISOString(), // 2 days ago
        content: 'Your grade for the Web Application Security Game has been posted. Check your game dashboard to view your results.',
        type: 'grade_available',
        gameId: 'game002',
        gameName: 'Web Application Security'
      }
    ]
  ...
  const handleReview = (notification) => {
    ...
    switch (notification.type) {
      case 'game_invitation':
        // Navigate to game details or join game page
        console.log('Review game invitation:', notification)
        // navigate(`/mxrep/${slug}/student-panel/my-games/${notification.gameId}`)
        break
      case 'team_assignment':
        // Navigate to game/team details
        console.log('Review team assignment:', notification)
        // navigate(`/mxrep/${slug}/student-panel/my-games/${notification.gameId}`)
        break
      case 'grade_available':
        // Navigate to game results
        console.log('Review grade:', notification)
        // navigate(`/mxrep/${slug}/student-panel/my-games/${notification.gameId}`)
        break
      default:
        ...
        <div className="flex items-center justify-between mb-2">
          <div className='text-left'>
            ...
            <p className="text-slate-600 mt-1">
              Review and manage game invitations and notifications
            </p>
          </div>
        ...
        {!notificationsLoading && !error && notifications.length === 0 && (
          <div className="flex flex-col items-center justify-center py-16 px-4">
            ...
            <p className="text-slate-600 text-center max-w-sm">
              You're all caught up! New game invitations and notifications will appear here.
            </p>
          </div>
        )}
