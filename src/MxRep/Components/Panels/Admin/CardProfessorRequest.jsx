...
function CardProfessorRequest({ notification, onReview }) {
  ...
  const handleReview = () => {
    if (onReview) {
      ...
      navigate(`/mxrep/${slug}/admin-panel/inbox/${notification._id}`)
    }
  }
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mb-1">
              ...
              <h3 className="text-base font-semibold text-slate-900 truncate">
                Professor Registration Request: {fullName}
              </h3>
            ...
            <div className="flex items-center gap-2 text-sm text-slate-500">
              ...
              {notification.department && (
                <>
                  <span>•</span>
                  <span className="font-medium text-slate-700">{notification.department}</span>
                </>
              )}
            </div>
          </div>
...
export default CardProfessorRequest
